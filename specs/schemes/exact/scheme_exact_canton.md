...
## `PaymentRequirements` for `exact-canton`
...
- `amount`: Daml Decimal string, 10 decimal places. `"0.1000000000"` = 0.1 CC,
  `"1.0000000000"` = 1 CC. Must match exactly (string equality) what the Daml
  contract encodes.
